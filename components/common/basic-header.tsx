...
const BasicHeader: React.FC<BasicHeaderProps> = ({ heading, subHeading }) => {
    return (
        <section className="relative w-full -top-32 h-[420px] sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[420px] overflow-hidden bg-cover bg-center " style={{ backgroundImage: 'url(/bg.png)' }} >
