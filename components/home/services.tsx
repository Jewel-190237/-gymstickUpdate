...
const Services: React.FC = () => {
    return (
        <section className='container lg:mb-[120px] mb-[60px] '>
            <div className='flex justify-between items-end '>
                <BannerTitle subtitle={"Services"} title={"Services We're Offering"} className={''} />
                <button className='text-primary text-base underline cursor-pointer md:block hidden '>All Servics</button>
            </div>
